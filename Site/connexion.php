            			...
            			if ($_REQUEST['personnel']==true)
							echo "<label style='position:absolute; left:26%' for='fonction'> Function :</label>"
								."<select id='fonction' name='fonction'>"
									."<option value='Gestionnaire_compte'>Gestionnaire de comptes</option>"
									."<option value='Gestionnaire_oeuvre'>Gestionnaire d'oeuvres</option>"
        ...
        if (empty($login) or empty($mdp)) {
            ...
            if (empty($type)){
            	...
            	$txt = 
				    ...
				    . "where co.type = :type and cl.etat != 'Suspendu' and cl.etat != 'En_cours_de_validation' and  (co.adresseMail = :login "
